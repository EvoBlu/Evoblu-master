    ...
    CMainParams() {
      ...
      //  CScript pubkey = 030d2ceab66550478daae8ef5df77e6c8f2f5808372fec357f4c3915b6455fbd88;
       // vout[0].scriptPubKey = CScript('030d2ceab66550478daae8ef5df77e6c8f2f5808372fec357f4c3915b6455fbd88');
        CTransaction txNew(1, 1511650354, vin, vout, 0);
        genesis.vtx.push_back(txNew);
        genesis.hashPrevBlock = 0;
        genesis.hashMerkleRoot = genesis.BuildMerkleTree();
        genesis.nVersion = 1;
        genesis.nTime    = 1511650354;
        genesis.nBits    = bnProofOfWorkLimit.GetCompact();
        genesis.nNonce   = 2198;

      hashGenesisBlock = genesis.GetHash();
  assert(hashGenesisBlock == uint256("0x522c9a1e5fa05fa1926d2ad810a468ab2b39c405ae20f9d82c9e37e9de583038"));
 assert(genesis.hashMerkleRoot == uint256("0x17547e1504528090fbc85e0121e393946bec02968b70d60e8984a6cd64bb4f07"));
...
/*if (true && genesis.GetHash() != hashGenesisBlock)
    ...
    LogPrintf("Now replace the values, reComment the Genesis mining code and reCompile. \n");
} } */
...
public:
    CTestNetParams() {
        ...
        hashGenesisBlock = genesis.GetHash();
      //  assert(hashGenesisBlock == uint256("0x000000dcc46e842b020cf33fbe6f2fb2cfea6d0b0ecd086d527a5035b18900ddde3f3"));
