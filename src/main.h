...
static const int64_t COIN_YEAR_REWARD = 10 * CENT; // 10% per year for first two years , 5% e syars after
...
inline bool IsProtocolV3(int64_t nTime) { return TestNet() || nTime > 1511371593; }
